<div class="absolute inset-x-0 top-0 z-50 mb-30">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            @auth
                ...
                <a class="text-sm/6 font-semibold text-gray-900 " href="{{ route('profile.show') }}">profile</a>
            @else
    ...
    <div id="mobile-menu" class="fixed inset-x-0 z-50 hidden">
        ...
        <div
            class="fixed inset-0 right-0 z-50 w-full max-w-sm overflow-y-auto bg-white px-6 py-6 transition-transform duration-300 transform translate-x-full">
