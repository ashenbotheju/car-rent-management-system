            ...
            <div class="vehicle-info">
                ...
                <div class="flex items-center mb-6">
                    ...
                    {{-- <div class="flex items-center">
                        ...
                        <span class="text-sm text-gray-500">1624 reviews</span>
                    </div> --}}
                </div>
                ...
                <!-- Color Options -->
                {{-- <div class="mb-8">
                    <h3 class="text-lg font-medium text-gray-900 mb-3">Bag Color</h3>
                    <div class="flex gap-3">
                        <div class="color-option active" style="background-color: #10B981;" onclick="selectColor(this)"></div>
                        <div class="color-option" style="background-color: #FBBF24;" onclick="selectColor(this)"></div>
                        <div class="color-option" style="background-color: #F43F5E;" onclick="selectColor(this)"></div>
                        <div class="color-option" style="background-color: #2563EB;" onclick="selectColor(this)"></div>
                    </div>
                </div> --}}
                
                <!-- Size Options -->
                {{-- <div class="mb-8">
                    <h3 class="text-lg font-medium text-gray-900 mb-3">Bag Size</h3>
                    <div class="flex flex-wrap gap-3">
                        <div class="size-option" onclick="selectSize(this)">56 cm (S)</div>
                        <div class="size-option active" onclick="selectSize(this)">67 cm (M)</div>
                        <div class="size-option" onclick="selectSize(this)">77 cm (L)</div>
                    </div>
                </div> --}}
